...
export async function GET(req: Request) {
  return new Promise<NextResponse>((resolve) => {
    handleIterationsGet(adaptRequest(req), createResponseAdapter(resolve));
  });
}

export async function POST(req: Request) {
  return new Promise<NextResponse>((resolve) => {
    handleIterationsPost(adaptRequest(req), createResponseAdapter(resolve));
  });
}

export async function DELETE(req: Request) {
  return new Promise<NextResponse>((resolve) => {
    handleIterationsDelete(adaptRequest(req), createResponseAdapter(resolve));
  });
}
